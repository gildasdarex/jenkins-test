...
@Table(name="COOPERATIVE",
        uniqueConstraints = {@UniqueConstraint(columnNames = {"numordregroupe", "codecommune", "idlot"})}
)
public class Cooperative  implements java.io.Serializable {


     private Integer idgroupe;
     private Integer numordregroupe;
    ...
    @Column(name="numordregroupe")
    public Integer getNumordregroupe() {
        return numordregroupe;
    }

    public void setNumordregroupe(Integer numordregroupe) {
        this.numordregroupe = numordregroupe;
    }
